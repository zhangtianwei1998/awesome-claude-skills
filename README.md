...
| 对象 | 关系 | 建议 |
|------|------|------|
| **addyosmani/web-quality-skills** | ✅ 互补（代码实践 vs. 性能指标）| 前端项目建议同时安装 |
...
| **安装** | `npx skills add addyosmani/web-quality-skills` |

**原理与作用**

Google Chrome 工程师 Addy Osmani 开源的 Web 质量审查 Skill 集合，将 150+ 次 Lighthouse 审查经验固化为可复用规则。

> 📝 原列于"全流程"类，因其核心价值在 Web 性能领域，调整至"前端开发"类。

**目标质量阈值（编码进 Skill）：**
- LCP ≤ 2.5s, INP ≤ 200ms, CLS ≤ 0.1
- Lighthouse Performance ≥ 90, Accessibility = 100, SEO ≥ 95

**核心 Skills：**

| Skill | 用途 |
|-------|------|
| `web-quality-audit` | 全方位质量审查（跨所有类别）|
| `performance` | 加载/运行时性能（关键渲染路径、bundle、图片、缓存）|
| `core-web-vitals` | LCP / INP / CLS 专项优化 |
| `accessibility` | WCAG 2.2 合规 |
| `seo` | 搜索引擎优化 |
| `best-practices` | HTTPS、安全 headers、现代 API |

**重叠与冲突**

| 对象 | 关系 | 建议 |
|------|------|------|
| **vercel-labs/agent-skills** | ✅ 互补 | vercel-labs 关注代码实践，addyosmani 关注性能指标；前端项目建议同时安装 |
| **anthropics/skills frontend-design** | ✅ 互补 | anthropics 关注 UI 美观，addyosmani 关注性能合规；无冲突 |
...
| vercel-labs/agent-skills | addyosmani/web-quality-skills | ✅ 互补 | 前端项目建议同时安装 |
...
**全栈 / 前端向项目：**
```
gstack + andrej-karpathy-skills + vercel-labs/agent-skills + addyosmani/web-quality-skills + RTK
```
...
| web-quality-skills | [addyosmani/web-quality-skills](https://github.com/addyosmani/web-quality-skills) | 前端性能 | Lighthouse 指标达标 |
